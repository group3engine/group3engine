...
namespace vkutil {
    ...
    inline SSAOSettings ssaoSettings = {1, 1, 1.4f, 0.003f, 1.5f};
    inline SSRSettings ssrSettings = {1, 1, 1.0f, 0.001f, 0.001f};
    inline FogSettings fogSettings = { 30.0f, 0.016f, 0.1f, 0 };
