...
Composite::Composite(Context &context, Scene *scene, Image &LightingPass, Image &BloomPass, Image &SSAO, Image &SSRImage, Image &Fog, Image &Outline, const std::vector<Buffer>& debugUniform)
    : context{context},
      m_Scene{scene},
...
void Composite::Resize() {
    ...
    for (size_t i = 0; i < vkutil::MAX_FRAMES_IN_FLIGHT; i++) {
        ...
        vkutil::UpdateDescriptorSet(context, 0, imageInfo, m_descriptorSets[i], VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER);
    }
...
void Composite::CreatePipeline() {
    ...
    auto pipelineResult = PipelineBuilder(context.device, PipelineType::GRAPHICS, VertexBinding::NONE, 0)
                              ...
                              .AddShader(assetsPath / "shaders/" / "composite.frag.spv", ShaderType::FRAGMENT)
...
void Composite::CreateRenderPass() {
...
void Composite::CreateFramebuffer() {
...
void Composite::BuildDescriptors() {
    m_descriptorSets.resize(vkutil::MAX_FRAMES_IN_FLIGHT);
    {
        ...
        std::vector<VkDescriptorSetLayoutBinding> bindings = {
            ...
            vkutil::CreateDescriptorBinding(6, 1, VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER, VK_SHADER_STAGE_FRAGMENT_BIT),
    ...
    for (size_t i = 0; i < vkutil::MAX_FRAMES_IN_FLIGHT; i++) {
        ...
        vkutil::UpdateDescriptorSet(context, 7, bufferInfo, m_descriptorSets[i], VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER);
    }
}
