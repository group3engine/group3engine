...
public:
    ...
    static void DrawAll(VkCommandBuffer cmd, VkPipeline aPipeline, VkPipelineLayout aLayout,
...
public:
    ParticleSystem(Context &aContext, Scene *scene, ParticleSystemSettings const &aSettings);
    ~ParticleSystem();
    ...
    void Render(VkCommandBuffer cmd, VkPipeline aPipeline, VkPipelineLayout aLayout,
                const std::array<std::vector<VkDescriptorSet>, GlobalConfig::maxPlayers>
