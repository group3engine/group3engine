//
// shamelessly stolen from https://github.com/shivang51/bess/blob/main/Bess/src/settings/themes.cpp
//
...
Themes::Themes()
{
    ...
    m_themes["Dark"] = [this]()
    { setDarkThemeColors(); };
    m_themes["New Dark"] = [this]()
    { setNewDarkTheme(); };
    m_themes["Catpuccin Mocha"] = [this]()
    { setCatpuccinMochaColors(); };
    m_themes["Modern"] = [this]()
    { setModernColors(); };
    m_themes["Material You"] = [this]()
    { setMaterialYouColors(); };
    m_themes["Glass Theme"] = [this]()
    { setGlassTheme(); };
    m_themes["Fluent UI"] = [this]()
    { setFluentUITheme(); };
    m_themes["Fluent UI - Light"] = [this]()
