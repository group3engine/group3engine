...
void Context::TeardownSwapchain() {
    vkDeviceWaitIdle(device);
...
void Context::SetObjectName(VkDevice device, uint64_t objectHandle, VkObjectType objectType, const char *name) const {
...
bool Context::MakeContext(GLFWwindow *window) {
    mWindow = window;
    ...
    vkutil::maxAnisotropic = props.limits.maxSamplerAnisotropy;
