...
void NetworkedLocalCharacter::Update(double deltaTime)
{
    ...
    // jsonify
    std::string jsonToSend = "{ \"transform\": { \"position\": [" + to_string(position.GetX()) + "," + to_string(position.GetY()) + "," + to_string(position.GetZ()) + "], \"rotation\": [" + to_string(transform.rotation.x) + "," + to_string(transform.rotation.x) + "," + to_string(transform.rotation.x) + "," + to_string(transform.rotation.x) + "," + "], \"scale\": [" + to_string(transform.scale.x) + "," + to_string(transform.scale.y) + "," + to_string(transform.scale.z) + "] }, \"velocity\": [" + to_string(velocity.x) + "," + to_string(velocity.y) + "," + to_string(velocity.z) + "], \"mapName\": \"" + mapName + "\" }";
