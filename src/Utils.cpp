...
VkSampler CreateSampler(Context &context, VkSamplerAddressMode mode, VkBool32 EnableAnisotropic, VkCompareOp compareOp,
    ...
    samplerInfo.maxAnisotropy = EnableAnisotropic ? vkutil::maxAnisotropic : 1; // set max anisotropic supported by device if being used else set it to default 1
