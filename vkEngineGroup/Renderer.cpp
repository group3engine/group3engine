...
vk::Renderer::Renderer(Context& context) : context{context}
{
	...
	auto gltf = vk::LoadGLTF(context, "assets/vkEngineGroup/Sponza/Sponza.gltf");
	...
	directionalLight.position = glm::vec4(-0.2972, 7858.f, 790.0f, 15.0f); // -0.2972
	...
	for (size_t i = 0; i < 25; i++) {
		spotLightPositions.push_back(glm::vec4(i + 2.0f, 1.0f, 1.0f, 1.0f)); // Modify as needed
	}
