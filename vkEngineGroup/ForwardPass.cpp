...
void vk::ForwardPass::CreatePipeline()
{
	...
	auto defaultPipelineResult = vk::PipelineBuilder(context.device, PipelineType::GRAPHICS, VertexBinding::BIND, 0)
		.AddShader("../a12base/assets/vkEngineGroup/shaders/default.vert.spv", ShaderType::VERTEX)
		.AddShader("../a12base/assets/vkEngineGroup/shaders/default.frag.spv", ShaderType::FRAGMENT)
	...
	auto alphaMaskPipeline = vk::PipelineBuilder(context.device, PipelineType::GRAPHICS, VertexBinding::BIND, 0)
		.AddShader("../a12base/assets/vkEngineGroup/shaders/default.vert.spv", ShaderType::VERTEX)
		.AddShader("../a12base/assets/vkEngineGroup/shaders/alpha_masking.frag.spv", ShaderType::FRAGMENT)
		.SetInputAssembly(VK_PRIMITIVE_TOPOLOGY_TRIANGLE_LIST)
		.SetDynamicState({ {VK_DYNAMIC_STATE_VIEWPORT, VK_DYNAMIC_STATE_SCISSOR} })
