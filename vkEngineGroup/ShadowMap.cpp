...
void vk::ShadowMap::CreatePipeline()
{
	...
	auto ShadowMapPipelineRes = vk::PipelineBuilder(context.device, PipelineType::GRAPHICS, VertexBinding::BIND, 0)
		.AddShader("../a12base/assets/vkEngineGroup/shaders/shadow_map.vert.spv", ShaderType::VERTEX)
		.AddShader("../a12base/assets/vkEngineGroup/shaders/shadow_map.frag.spv", ShaderType::FRAGMENT)
